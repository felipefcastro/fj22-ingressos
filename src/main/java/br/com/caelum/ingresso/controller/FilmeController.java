...
import br.com.caelum.ingresso.modelo.DetalheDoFilme;
...
public class FilmeController {
    ...
    public ModelAndView detalhes(@PathVariable("id") Integer id){
    	...
    	Optional<DetalheDoFilme> detalheDoFilme = client.request(filme, DetalheDoFilme.class);
    	
    	modelAndView.addObject("sessoes", sessoes);
    	modelAndView.addObject("detalhes", detalheDoFilme.orElse(new DetalheDoFilme()));
